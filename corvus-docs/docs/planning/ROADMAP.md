...
1. **Phase 10 — Secure skill runtime + open library** — Engine 1 skill tools; gated Agent Skills (`SKILL.md`) install; launch bake; **10d** allowlisted registry browse + prepare-install. See [PHASE-10-SKILLS.md](PHASE-10-SKILLS.md).
